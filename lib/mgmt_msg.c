...
/**
 * Process streams container whole messages that have been pushed onto the FIFO.
 * This should be called from an event/timer handler and should be
 *rescheduleable.
 *
 * Args:
 *	ms: mgmt_msg_state for this process.
 ...
 * sending by mgmt_msg_send_msg. This function should be rescheduleable.
 *
 * Args:
 *	ms: mgmt_msg_state for this process.
 *	fd: socket/file to read data from.
